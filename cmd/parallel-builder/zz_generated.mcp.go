...
var Capabilities = engineframework.Capabilities{Platforms: []string{"any"}, Frozen: true, Incremental: false}
...
func handleConfigValidate(
	...
	if len(input.Platforms) > 0 {
		if err := engineframework.RefusePlatforms("parallel-builder", Capabilities, input.Platforms); err != nil {
			output.Valid = false
