...
var Capabilities = engineframework.Capabilities{Platforms: []string{"any"}, Frozen: false, Incremental: false}
...
func handleConfigValidate(
	...
	if len(input.Platforms) > 0 {
		if err := engineframework.RefusePlatforms("container-build-simple", Capabilities, input.Platforms); err != nil {
			output.Valid = false
